...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--min_learning_rate", type=float, default=1e-5, help="minimum learning rate"
    )
    ...
    parser.add_argument(
        "--global_batch_size", type=int, default=1, help="global batch size"
    )
    parser.add_argument(
        "--micro_batch_size", type=int, default=1, help="micro batch size per device"
    )
